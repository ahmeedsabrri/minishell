...
#    Updated: 2023/08/29 11:14:20 by asabri           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRC = src/env/env.c src/env/env_utils.c src/main.c src/lexer/lexer.c src/lexer/lexer_list.c gc/ft_malloc.c gc/utils_malloc.c
