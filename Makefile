...
#    Updated: 2023/08/31 02:31:03 by asabri           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = minishell

SRC = src/env/env.c src/env/env_utils.c src/main.c src/lexer/lexer.c src/lexer/lexer_list.c src/lexer/expand.c gc/ft_malloc.c gc/utils_malloc.c
